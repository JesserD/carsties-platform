...
public class AuctionControllerTests
{
    ...
    public async Task UpdateAuction_WithUpdateAuctionDto_ReturnsOkResponse()
    {
        ...
        var updateAuctionDto = _fixture.Build<UpdateAuctionDto>().Create();
    ...
    {
        // arrange
        _auctionRepo.Setup(repo => repo.GetAuctionEntityById(It.IsAny<Guid>())).ReturnsAsync(null as Auction);

        // act
        var result = await _controller.UpdateAuction(It.IsAny<Guid>(), It.IsAny<UpdateAuctionDto>());
